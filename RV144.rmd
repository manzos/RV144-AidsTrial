...
```
  The boxplot bar graph shows that the vaccine group fell within 50% for non-aids and 40% with aids. On the other hand, the placebo group fell within the 50% of non-aids and 60% with aids.Therefore the vaccine worked based on this data being presented in the results of research project.
...
rowPerc(results)
```
The numerical data called people and the categorical are the placebo and vaccine.The boxplot bar graph shows that the vaccine group fell within 50% for non-aids and 40% with aids. On the other hand, the placebo group fell within the 50% of non-aids and 60% with aids.Therefore the vaccine worked based on this data being presented in the results of research project.
...
```{r}
chisqtestGC(results, graph = TRUE,verbose = T)
```
```{r}
fisher.test(results)
```
According to the chitestGC the graph result shows that counts expected by null for the vacine resulted in 62.5 with aids. And then, the placebo results 62.5.This being the odds ratio is not equal to 1.On the other had, the actual result shows that 51 vaccine patients got aids and 74 placebo patients got aids.Based on this evidence the hypothises is 2.12 which i not equal to 1. 

## Conclusions

In the end all the numerical results and graphical results indicate that the vaccine was effective by 51 patients who recived the vaccine. the expected null count for the vaccine patients was 62.5. the chi-square contributions for the aids was 2.12, which shows that the true odds ration is not equal to 1.All inall, the vaccine is 40% effective. 
