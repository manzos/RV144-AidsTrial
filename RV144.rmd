...
The boxplot bar graph shows that the vaccine group fell within 50% for non-aids and 40% with aids. On the other hand, the placebo group fell within the 50% of non-aids and 60% with aids. 
### Numerical Results
...
According to the numerical results, the vaccine group demonstrates 40 people got aids and the placebo group shows that 59.2 got aids. The original assumption was that it would be 50-50. Based on 
